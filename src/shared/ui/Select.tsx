...
import type { SelectTriggerProps, SelectContentProps, SelectItemProps } from "@radix-ui/react-select"
...
const SelectTrigger = forwardRef<HTMLButtonElement, SelectTriggerProps & { className?: string }>(
...
const SelectContent = forwardRef<HTMLDivElement, SelectContentProps & { className?: string }>(
...
// Item 컴포넌트
const SelectItem = forwardRef<HTMLDivElement, SelectItemProps & { className?: string }>(
  ({ className, children, ...props }, ref) => (
